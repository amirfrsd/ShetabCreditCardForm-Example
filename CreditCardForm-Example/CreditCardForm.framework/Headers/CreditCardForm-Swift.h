...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CreditCardForm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14CreditCardForm11AKMaskField")
...
@interface AKMaskField (SWIFT_EXTENSION(CreditCardForm)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC14CreditCardForm18CreditCardFormView")
@interface CreditCardFormView : UIView
@property (nonatomic, strong) UIColor * _Nonnull defaultCardColor;
@property (nonatomic, strong) UIColor * _Nonnull cardHolderExpireDateTextColor;
@property (nonatomic, strong) UIColor * _Nonnull cardHolderExpireDateColor;
@property (nonatomic, strong) UIColor * _Nonnull backLineColor;
@property (nonatomic, strong) UIImage * _Nullable chipImage;
@property (nonatomic, copy) NSString * _Nonnull cardHolderString;
@property (nonatomic, copy) NSString * _Nonnull cardHolderPlaceholderString;
@property (nonatomic, copy) NSString * _Nonnull expireDatePlaceholderText;
@property (nonatomic, copy) NSString * _Nonnull cardNumberMaskExpression;
@property (nonatomic, copy) NSString * _Nonnull cardNumberMaskTemplate;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
@end
